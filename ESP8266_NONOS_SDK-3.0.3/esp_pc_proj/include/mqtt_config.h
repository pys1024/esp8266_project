...
/***********************************************************************************************************************/
#define CFG_HOLDER    0x00FF5503    /* Change this value to load default configurations */
...
#define MQTT_CLIENT_ID        "esp device "DEV_NAME    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define STA_PASS "Aliu102426" // your AP/router password
